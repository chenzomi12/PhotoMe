...
import static com.example.photome.Intensifyimage.IntensifyImage.ScaleType;
...
class IntensifyImageDelegate {
    ...
    private void initScaleType(Rect drawingRect) {
        ...
        Log.d(TAG, "DrawingRect=" + drawingRect + "/ImageArea=" + imageArea);
    ...
    public void zoomScale(Rect drawingRect, float scale, float focusX, float focusY) {
        ...
        Log.d(TAG, "Start=" + mStartRect + "/End=" + mEndRect);
        mZoomAnimator.start();
    }
